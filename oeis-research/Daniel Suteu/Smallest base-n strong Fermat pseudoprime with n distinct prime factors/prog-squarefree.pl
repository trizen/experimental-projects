...
# Known terms:
#   2047, 8911, 129921, 381347461, 333515107081, 37388680793101, 713808066913201, 665242007427361, 179042026797485691841, 8915864307267517099501, 331537694571170093744101, 2359851544225139066759651401
...
#   a(15) > 173076087233715951122638088175615
...
sub a($n) {
    ...
    for (;;) {
        ...
        my @arr;
        squarefree_strong_fermat_pseudoprimes_in_range($x, $y, $n, $n, sub($v) { push @arr, $v });
        if (@arr) {
            @arr = sort {$a <=> $b} @arr;
            return $arr[0];
        }
