...
foreach my $n(
    ...
    #"2019"
#    Couldn't find values for the following multiples: 2019 2199 2433 2469 2559 2631 2721 2811 2973 2991
2991
    ...
    say "# Searching upper-bounds for multiple k = $n";
