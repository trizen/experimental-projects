...
# Add diacritic to Romanian text (highly experimental).
...
my $string = do {
        open my $fh, '<:utf8', $input_file or die "$input_file: $!";
        local $/;
        <$fh>;
};
...
my %table = (
             ...
             'marti',            'marți',            'sambata',          'sâmbătă',
             'duminica',         'duminică',         'parghiilor',       'pârghiilor',
             'parghile',         'pârghile',         'parghilor',        'pârghilor',
             'parinte',          'părinte',          'parinti',          'părinți',
             'parintii',         'părinții',         'parti',            'părți',
             'particica',        'părticică',        'pasi',             'paşi',
             'pasii',            'paşii',            'pastrand',         'păstrând',
             'pastrandu-i',      'păstrându-i',      'pastrandu-le',     'păstrându-le',
             'pastrandu-si',     'păstrându-si',     'patruns',          'pătruns',
             'perfecti',         'perfecți',         'perfectie',        'perfecție',
             'perfectionari',    'perfecționări',    'perfectionarii',   'perfecționării',
             'perfectionariile', 'perfecționăriile', 'perfectionarile',  'perfecționările',
             'pesti',            'pești',            'pestii',           'peștii',
             'pestisor',         'peștișor',         'piete',            'piețe',
             'pieti',            'pieți',            'pietii',           'pieții',
             'placea',           'plăcea',           'placere',          'plăcere',
             'placinte',         'plăcinte',         'plaman',           'plămân',
             'plamani',          'plămâni',          'plang',            'plâng',
             'plange',           'plânge',           'plangi',           'plângi',
             'platit',           'plătit',           'plecam',           'plecăm',
             'porcarie',         'porcărie',         'porcarii',         'porcării',
             'poti',             'poți',             'potoleste-te',     'potolește-te',
             'povesti',          'povești',          'pozitie',          'poziție',
             'pozitii',          'poziții',          'pozitiilor',       'pozițiilor',
             'pozitilor',        'poziților',        'pozitionati',      'poziționați',
             'prajit',           'prăjit',           'prajite',          'prăjite',
             'prajiti',          'prăjiți',          'prajituri',        'prăjituri',
             'pregati',          'pregăti',          'pregatit',         'pregătit',
             'pregatita',        'pregătită',        'pregatiti',        'pregătiți',
             'prelucrati',       'prelucrați',       'presedinte',       'președinte',
             'pretuit',          'prețuit',          'pretuite',         'prețuite',
             'pretul',           'prețul',           'preturi',          'prețuri',
             'preturile',        'prețurile',        'print',            'prinț',
             'priveste',         'privește',         'proaspat',         'proaspăt',
             'prostut',          'prostuț',          'protectie',        'protecție',
             'protectiei',       'protecției',       'protectii',        'protecții',
             'publicatie',       'publicație',       'publicatiei',      'publicației',
             'puneti',           'puneți',           'purtator',         'purtător',
             'purtatori',        'purtători',        'pusi',             'puşi',
             'putin',            'puțin',            'putine',           'puține',
             'puturosi',         'puturoși',         'rabdare',          'răbdare',
             'rabdator',         'răbdător',         'racire',           'răcire',
             'rahati',           'rahați',           'rahatii',          'rahații',
             'raman',            'rămân',            'ramane',           'rămâne',
             'ramasesem',        'rămăsesem',        'rand',             'rând',
             'randul',           'rândul',           'rani',             'răni',
             'raniri',           'răniri',           'ranit',            'rănit',
             'ranite',           'rănite',           'atinga',           'atingă',
...
$string =~ s/\bsarbat\B/sărbăt/g;
$string =~ s/\b(e|îi)(\s+)cruda\b/$1$2crudă/g;
$string =~ s/\b(P|p)rabusi/$1răbuși/g;
$string =~ s/\bdesertac\B/deșertăc/g;
$string =~ s/\bdeserturi/deșerturi/g;
$string =~ s/\bincarc\B/încărc/g;
$string =~ s/\bIncarc\B/Încărc/g;
$string =~ s/\bincurc/încurc/g;
$string =~ s/\bpana(\s+)(în|la|vine|pleaca)/până$1$2/g;
$string =~ s/\bIncurc/Încurc/g;
$string =~ s/\binaltarea/înălțarea/g;
$string =~ s/\binaltat/înălțat/g;
$string =~ s/\b(P|p)amant/$1ământ/g;
...
$string =~ s/([^AaEeIiUuOo])(\s+)mașină(\s+)([^\s.]+)([AaăĂ])\b/$1$2mașina$3$4$5/g;
$string =~ s/([Mm])așin([ăa])(\s+)([^\s.]+)a\b/$1așin$2$3$4ă/g;
